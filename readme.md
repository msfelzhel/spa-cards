...
## 📖 О проекте
Это одностраничное приложение, которое отображает и управляет карточками товаров с расширенными возможностями фильтрации, поиска и сортировки. Приложение позволяет пользователям просматривать, искать, фильтровать и управлять товарами в интуитивно понятном интерфейсе.
